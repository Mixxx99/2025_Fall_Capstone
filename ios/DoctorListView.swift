        ...
        ZStack {
            ...
            VStack(spacing: 10) {
                ...
                HStack {
                    ...
                    TextField("Search by name, specialty, phone, or email…", text: $search)
                            ...
                            Button {
                                ...
                                HStack(alignment: .top, spacing: 12) {
                                    ...
                                    VStack(alignment: .leading, spacing: 4) {
                                        ...
                                        // NEW: phone, email, address visible if present
                                        if let phone = doc.phone, !phone.isEmpty {
                                            Button { call(phone: phone) } label: {
                                                Label(phone, systemImage: "phone.fill")
                                                    .font(.caption)
                                            }
                                        }
                                        if let email = doc.email, !email.isEmpty {
                                            Label(email, systemImage: "envelope")
                                                .font(.caption)
                                                .foregroundStyle(.secondary)
                                        }
                                        if let addr = doc.address, !addr.isEmpty {
